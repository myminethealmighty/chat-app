    ...
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-sm">
      ...
      <div className="mt-2 flex gap-4">
        <input
          {...register("email")}
          type="text"
          className="block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 shadow-sm ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6"
          placeholder="mymine@example.com"
        />
        <Button>Add</Button>
      </div>
